...
class FourVector {
    public:
      ...
      FourVector operator*(const double alfa) const {
	      FourVector ret(m_px*alfa, m_py*alfa,m_pz*alfa,sqrt(m()*m()+m_pz*alfa*m_pz*alfa+m_py*alfa*m_py*alfa+m_px*alfa*m_px*alfa));
	      return ret;
      }
      //setters
